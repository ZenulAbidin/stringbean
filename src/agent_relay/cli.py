        ...
        return Config(
            agents={
                "gpt56-high": AgentConfig(
                    ...
                    role="orchestrator",
                    permissions="read_write",
                    command=_codex_command("gpt-5.6-sol", "high"),
                    mode="high",
                    prompt_transport="stdin",
                ),
                "gpt56-medium": AgentConfig(
                    ...
                    role="advisor",
                    permissions="read_only",
                    command=_codex_command("gpt-5.6-sol", "medium"),
                    mode="medium",
                    prompt_transport="stdin",
                ),
                "gpt56-low": AgentConfig(
                    ...
                    role="reviewer",
                    permissions="read_only",
                    command=_codex_command("gpt-5.6-sol", "low"),
                    mode="low",
                    prompt_transport="stdin",
                ),
                "gpt56-terra-high": AgentConfig(
                    name="gpt56-terra-high",
                    adapter="codex",
                    model="gpt-5.6-terra",
                    role="orchestrator",
                    permissions="read_write",
                    command=_codex_command("gpt-5.6-terra", "high"),
                    mode="high",
                    prompt_transport="stdin",
                ),
                "gpt56-terra-medium": AgentConfig(
                    name="gpt56-terra-medium",
                    adapter="codex",
                    model="gpt-5.6-terra",
                    role="advisor",
                    permissions="read_only",
                    command=_codex_command("gpt-5.6-terra", "medium"),
                    mode="medium",
                    prompt_transport="stdin",
                ),
                "gpt56-terra-low": AgentConfig(
                    name="gpt56-terra-low",
                    adapter="codex",
                    model="gpt-5.6-terra",
                    role="reviewer",
                    permissions="read_only",
                    command=_codex_command("gpt-5.6-terra", "low"),
                    mode="low",
                    prompt_transport="stdin",
                ),
                "gpt56-luna-high": AgentConfig(
                    name="gpt56-luna-high",
                    adapter="codex",
                    model="gpt-5.6-luna",
                    role="orchestrator",
                    permissions="read_write",
                    command=_codex_command("gpt-5.6-luna", "high"),
                    mode="high",
                    prompt_transport="stdin",
                ),
                "gpt56-luna-medium": AgentConfig(
                    name="gpt56-luna-medium",
                    adapter="codex",
                    model="gpt-5.6-luna",
                    role="advisor",
                    permissions="read_only",
                    command=_codex_command("gpt-5.6-luna", "medium"),
                    mode="medium",
                    prompt_transport="stdin",
                ),
                "gpt56-luna-low": AgentConfig(
                    name="gpt56-luna-low",
                    adapter="codex",
                    model="gpt-5.6-luna",
                    role="reviewer",
                    permissions="read_only",
                    command=_codex_command("gpt-5.6-luna", "low"),
                    mode="low",
                    prompt_transport="stdin",
                ),
                ...
                "claude-fable": AgentConfig(
                    name="claude-fable",
                    adapter="claude",
                    model="fable",
                    role="advisor",
                    permissions="read_only",
                    command=_claude_command("fable"),
                    mode="medium",
                    prompt_transport="stdin",
                ),
                "claude-opus-4-8": AgentConfig(
                    ...
                    role="reviewer",
                    permissions="read_only",
                    command=_claude_command("claude-opus-4-8"),
                    mode="high",
                    prompt_transport="stdin",
                ),
                "claude-sonnet-5": AgentConfig(
                    ...
                    role="advisor",
                    permissions="read_only",
                    command=_claude_command("claude-sonnet-5"),
                    mode="medium",
                    prompt_transport="stdin",
                ),
                "claude-haiku-4-5-20251001": AgentConfig(
                    name="claude-haiku-4-5-20251001",
                    adapter="claude",
                    model="claude-haiku-4-5-20251001",
                    role="reviewer",
                    permissions="read_only",
                    command=_claude_command("claude-haiku-4-5-20251001"),
                    mode="low",
                    prompt_transport="stdin",
                ),
                "claude-fable-5": AgentConfig(
                    ...
                    role="advisor",
                    permissions="read_only",
                    command=_claude_command("claude-fable-5"),
                    mode="medium",
                    prompt_transport="stdin",
                ),
